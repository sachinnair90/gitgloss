...
- **Architecture:** Hexagonal (ports & adapters). Static catalog in Git + ShadowCache SQL dual-write for immediacy. TTL-based cleanup via Azure Function timer trigger.
- **Created:** 2026-04-06
